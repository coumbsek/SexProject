...
#define SERVER_CLIENT "[Server->Client]"
#define CLIENT_SERVER "[Client->Server]"
#define ANNUAIRE_SERVER ["Annuaire->Server]"
#define SERVER_ANNUAIRE "[Server->Annuraire]"

#define ID_SERVER 0x00F0
